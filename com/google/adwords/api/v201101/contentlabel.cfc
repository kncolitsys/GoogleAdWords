...
<cfproperty name="contentLabelType" required="no" type="string" hint="Content label type This field can be selected using the value 'ContentLabelType'.This field can be filtered on. This field is required and should not be null." seq="3">
