...
---> 
<cfcomponent displaname="reportdefinitionserviceget" extends="utils">

<cfproperty name="selector" required="no" type="ReportDefinitionSelector" hint="This field is required and should not be null." seq="1">
