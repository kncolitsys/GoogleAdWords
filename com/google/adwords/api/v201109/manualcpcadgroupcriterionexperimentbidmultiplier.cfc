...
---> 
<cfcomponent displaname="ManualCPCAdGroupCriterionExperimentBidMultiplier" hint="AdGroupCriterion level bid multiplier used in manual CPC bidding strategies." extends="AdGroupCriterionExperimentBidMultiplier">

<cfproperty name="maxCpcMultiplier" required="no" type="BidMultiplier" hint="Multiplier used for adjusting bids in manual maximum CPC bidding strategies. This field can be selected using the value 'MaxCpcMultiplier'.This field can be filtered on." seq="2">
