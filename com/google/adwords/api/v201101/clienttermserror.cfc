...
---> 
<cfcomponent displaname="ClientTermsError" hint="Encapsulates the errors thrown during client terms checks for adwords." extends="ApiError">
...
<cfset setApiErrorType("ClientTermsError")>
