...
<cfproperty name="campaignId" required="no" type="long" hint="Campaign id of campaign which ad extension connected to This field can be selected using the value 'CampaignId'.This field can be filtered on. This field is required and should not be null when it is contained within Operators : ADD, REMOVE." seq="1">
