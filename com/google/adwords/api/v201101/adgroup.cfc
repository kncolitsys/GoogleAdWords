...
<cfproperty name="id" required="no" type="long" hint="AdGroup id This field can be selected using the value 'Id'.This field can be filtered on. This field is read only and should not be set for following Operators : ADD. If this field is sent to the API, it will be ignored. This field is required and should not be null when it is contained within Operators : SET, REMOVE." seq="1">
...
<cfproperty name="campaignName" required="no" type="string" hint="Name of the campaign with which this ad group is associated. This field can be selected using the value 'CampaignName'.This field can be filtered on. This field is read only and should not be set for following Operators : ADD. If this field is sent to the API, it will be ignored." seq="3">
...
<cfproperty name="experimentData" required="no" type="AdGroupExperimentData" hint="The campaign bidding strategy specific experiment data for this adgroup." seq="7">
<cfproperty name="stats" required="no" type="Stats" hint="Statistics for this ad group, returned by get() only if AdGroupSelector statsSelector is specified." seq="8">
