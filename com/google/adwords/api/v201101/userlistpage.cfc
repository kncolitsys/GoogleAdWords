...
---> 
<cfcomponent displaname="UserListPage" hint="Contains a list of user lists resulting from the filtering and paging of the get call." extends="Page">

<cfproperty name="entries" required="no" type="UserList[]" hint="The result entries in this page." seq="3">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setPageType("UserListPage")>
