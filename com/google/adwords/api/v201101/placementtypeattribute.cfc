...
---> 
<cfcomponent displaname="PlacementTypeAttribute" hint="Attribute type that contains a PlacementType value." extends="Attribute">

<cfproperty name="value" required="no" type="string" hint="PlacementType value contained by this Attribute. This field is required and should not be null." seq="2">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setAttributeType("PlacementTypeAttribute")>
