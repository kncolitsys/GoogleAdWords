...
---> 
<cfcomponent displaname="TrafficEstimatorError" hint="Base error class for com.google.ads.api.services.trafficestimator.TrafficEstimatorService." extends="ApiError">
...
<cfset setApiErrorType("TrafficEstimatorError")>
