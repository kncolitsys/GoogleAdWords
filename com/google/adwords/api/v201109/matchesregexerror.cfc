...
---> 
<cfcomponent displaname="MatchesRegexError" hint="A list of all errors associated with the com.google.ads.api.services.common.validation.constraints.MatchesRegex constraint." extends="ApiError">
...
<cfset setApiErrorType("MatchesRegexError")>
