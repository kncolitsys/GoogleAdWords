...
---> 
<cfcomponent displaname="trafficestimatorserviceget" extends="utils">

<cfproperty name="selector" required="no" type="TrafficEstimatorSelector" hint="This field is required and should not be null." seq="1">
