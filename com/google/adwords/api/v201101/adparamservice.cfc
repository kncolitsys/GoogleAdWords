...
<cffunction name="get" access="public" returntype="AdParamPage" hint="Returns the ad parameters that match the criteria specified in the selector. @param selector Specifies which ad parameters to return. @return A list of ad parameters." output="No">
<cfargument name="selector" required="no" type="AdParamSelector" hint="This field is required and should not be null."> 
...
<cfset var oAdParamServiceGet="">
	...
	<cftry>
		...
		<cfset oAdParamServiceGet.setSelector(selector)>
...
<cffunction name="getServiceUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['serviceUrl']" default="https://adwords.google.com/api/adwords/cm/v201101/AdParamService">
...
<cffunction name="getSandboxUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['sandboxUrl']" default="https://adwords-sandbox.google.com/api/adwords/cm/v201101/AdParamService">
