...
---> 
<cfcomponent displaname="infoserviceget" extends="utils">

<cfproperty name="selector" required="no" type="InfoSelector" hint="This field is required and should not be null." seq="1">
