...
<cfproperty name="clientEmails" required="no" type="string[]" hint="List of login emails used to identify the clients to retrieve the API usage for. If the list is null or empty, return the API usage for all clients." seq="5">
<cfproperty name="apiUsageType" required="no" type="string" hint="The API usage type information that needs to be fetched. This field is required and should not be null." seq="6">
