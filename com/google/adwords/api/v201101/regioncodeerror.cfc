...
---> 
<cfcomponent displaname="RegionCodeError" hint="A list of all errors associated with the @RegionCode constraints." extends="ApiError">
...
<cfset setApiErrorType("RegionCodeError")>
