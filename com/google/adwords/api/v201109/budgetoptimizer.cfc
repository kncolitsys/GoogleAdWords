...
<cfproperty name="enhancedCpcEnabled" required="no" type="boolean" hint="The enhanced CPC bidding option for the campaign, which enables bids to be enhanced based on conversion optimizer data. For more information about enhanced CPC, see the article What is Enhanced CPC?. This field can be selected using the value 'EnhancedCpcEnabled'.This field can be filtered on." seq="2">
