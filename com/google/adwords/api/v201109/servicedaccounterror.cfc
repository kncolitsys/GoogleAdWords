...
---> 
<cfcomponent displaname="ServicedAccountError" hint="Errors that can occur when contacting ServicedAccountService." extends="ApiError">
...
<cfset setApiErrorType("ServicedAccountError")>
