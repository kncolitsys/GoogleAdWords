...
---> 
<cfcomponent displaname="adparamservicemutate" extends="utils">

<cfproperty name="operations" required="no" type="AdParamOperation[]" hint="This field must not contain null elements. This field must contain at least one element. This field is required and should not be null. The following Operators are supported: SET, REMOVE." seq="1">
