...
<cfproperty name="prerequisiteJobIds" required="no" type="long[]" hint="Ids of jobs that must successfully complete before this job can be processed. The maximum size of this collection is 3." seq="1">
