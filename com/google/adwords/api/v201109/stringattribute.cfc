...
---> 
<cfcomponent displaname="StringAttribute" hint="Attribute type that contains a string value." extends="Attribute">

<cfproperty name="value" required="no" type="string" hint="String value contained by this Attribute. This field is required and should not be null." seq="2">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setAttributeType("StringAttribute")>
