...
---> 
<cfcomponent displaname="StringLengthError" hint="A list of all errors associated with the @ContentsString constraint." extends="ApiError">
...
<cfset setApiErrorType("StringLengthError")>
