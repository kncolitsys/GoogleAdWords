...
<cfproperty name="JobSelector_Type" required="no" type="string" xmlattribute="xsi:type" xmlnamespace="xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns='https://adwords.google.com/api/adwords/cm/v201101'" hint="This field indicates the subtype of JobSelector of this instance. It is ignored on input, and instead xsi:type should be specified." seq="3">
