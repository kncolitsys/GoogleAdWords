...
<cfproperty name="headline" required="no" type="string" hint="The headline of the ad This field can be selected using the value 'MobileAdHeadline'." seq="8">
<cfproperty name="description" required="no" type="string" hint="The description line This field can be selected using the value 'MobileAdDescription'." seq="9">
<cfproperty name="markupLanguages" required="no" type="string[]" hint="The list of markup languages to use for the mobile ad. This field can be selected using the value 'MobileAdMarkupLanguages'." seq="10">
<cfproperty name="mobileCarriers" required="no" type="string[]" hint="The list of mobile carriers to use for the mobile ad. Each string must be of the form 'CarrierName@CountryCode'. To specify that all available carriers are to be used, use the reserved keyword 'ALLCARRIERS'. See available mobile carriers. This field can be selected using the value 'MobileAdMobileCarriers'." seq="11">
<cfproperty name="businessName" required="no" type="string" hint="The business name of the mobile ad. Must not exceed 20 characters (except for ads targeted to Japan, which must not exceed 10 Japanese characters). This field can be selected using the value 'MobileAdBusinessName'." seq="12">
<cfproperty name="countryCode" required="no" type="string" hint="The country code for the phone number in the click-to-call mobile ad. The click-to-call ad will display only in this country. This field will be used to verify the phone number format and validate the targeted mobile carriers. This field can be selected using the value 'MobileAdCountryCode'." seq="13">
<cfproperty name="phoneNumber" required="no" type="string" hint="The click-to-call phone number. Must not exceed 20 characters. This field can be selected using the value 'MobileAdPhoneNumber'." seq="14">
