...
<cfproperty name="keywordEstimateRequests" required="no" type="KeywordEstimateRequest[]" hint="The keywords to estimate. This field must contain distinct elements. This field must not contain null elements. This field must contain at least one element. This field is required and should not be null." seq="3">
