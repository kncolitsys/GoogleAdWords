...
---> 
<cfcomponent displaname="ServicedAccountService" hint="Use this service to retrieve accounts managed (directly or indirectly) by your MCC account. The returned graph contains a list of all accounts and a list of links, where each link describes the relationship between two accounts." extends="utils">
...
<cffunction name="getServiceUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['serviceUrl']" default="https://adwords.google.com/api/adwords/mcm/v201101/ServicedAccountService">
...
<cffunction name="getSandboxUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['sandboxUrl']" default="https://adwords-sandbox.google.com/api/adwords/mcm/v201101/ServicedAccountService">
