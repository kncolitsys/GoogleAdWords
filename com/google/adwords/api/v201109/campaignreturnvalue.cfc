...
---> 
<cfcomponent displaname="CampaignReturnValue" hint="A container for return values from the CampaignService." extends="ListReturnValue">

<cfproperty name="value" required="no" type="Campaign[]" seq="2">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setListReturnValueType("CampaignReturnValue")>
