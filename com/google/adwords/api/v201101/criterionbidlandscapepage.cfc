...
---> 
<cfcomponent displaname="CriterionBidLandscapePage" hint="Contains a subset of CriterionBidLandscapePage objects resulting from the filtering and paging of getCriterionBidLandscape call." extends="NoStatsPage">

<cfproperty name="entries" required="no" type="CriterionBidLandscape[]" hint="The result entries in this page." seq="1">
