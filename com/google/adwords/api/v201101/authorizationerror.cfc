...
---> 
<cfcomponent displaname="AuthorizationError" hint="Errors that are thrown due to an authorization problem." extends="ApiError">
...
<cfset setApiErrorType("AuthorizationError")>
