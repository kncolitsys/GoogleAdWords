...
---> 
<cfcomponent displaname="TargetingIdeaError" hint="Base error class for the com.google.ads.api.services.targetingideas.TargetingIdeaService." extends="ApiError">
...
<cfset setApiErrorType("TargetingIdeaError")>
