...
---> 
<cfcomponent displaname="CampaignCriterionOperation" hint="Generic operation (add, remove and set) for campaign criteria." extends="Operation">

<cfproperty name="operand" required="no" type="CampaignCriterion" hint="This field is required and should not be null." seq="3">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setOperationType("CampaignCriterionOperation")>
