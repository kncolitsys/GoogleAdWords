...
---> 
<cfcomponent displaname="SettingError" hint="Indicates a problem with campaign settings." extends="ApiError">

<cfproperty name="reason" required="no" type="string" hint="The setting error reason." seq="5">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setApiErrorType("SettingError")>
