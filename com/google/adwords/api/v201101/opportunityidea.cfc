...
---> 
<cfcomponent displaname="OpportunityIdea" extends="utils">

<cfproperty name="data" required="no" type="OpportunityAttribute_AttributeMapEntry[]" hint="This field is required and should not be null." seq="1">
