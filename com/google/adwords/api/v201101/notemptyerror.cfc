...
---> 
<cfcomponent displaname="NotEmptyError" hint="A list of all errors associated with the @NotEmpty constraints." extends="ApiError">
...
<cfset setApiErrorType("NotEmptyError")>
