...
---> 
<cfcomponent displaname="QuotaCheckError" hint="Encapsulates the errors thrown during developer quota checks." extends="ApiError">
...
<cfset setApiErrorType("QuotaCheckError")>
