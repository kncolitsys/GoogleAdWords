...
---> 
<cfcomponent displaname="LocationCriterionServiceError" hint="Represents errors thrown by the get operation." extends="ApiError">
...
<cfset setApiErrorType("LocationCriterionServiceError")>
