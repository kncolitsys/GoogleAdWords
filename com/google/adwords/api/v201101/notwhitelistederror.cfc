...
---> 
<cfcomponent displaname="NotWhitelistedError" hint="Indicates that the customer is not whitelisted for accessing the API." extends="ApiError">
...
<cfset setApiErrorType("NotWhitelistedError")>
