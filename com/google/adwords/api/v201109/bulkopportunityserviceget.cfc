...
---> 
<cfcomponent displaname="bulkopportunityserviceget" extends="utils">

<cfproperty name="selector" required="no" type="BulkOpportunitySelector" hint="This field is required and should not be null." seq="1">
