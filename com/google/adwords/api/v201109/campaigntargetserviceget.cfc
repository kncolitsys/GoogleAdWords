...
---> 
<cfcomponent displaname="campaigntargetserviceget" extends="utils">

<cfproperty name="selector" required="no" type="CampaignTargetSelector" hint="This field is required and should not be null." seq="1">
