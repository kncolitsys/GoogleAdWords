...
---> 
<cfcomponent displaname="bulkmutatejobserviceget" extends="utils">

<cfproperty name="selector" required="no" type="BulkMutateJobSelector" hint="This field is required and should not be null." seq="1">
