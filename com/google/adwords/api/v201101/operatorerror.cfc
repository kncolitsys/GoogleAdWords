...
---> 
<cfcomponent displaname="OperatorError" hint="A list of all errors associated with the @SupportedOperators constraints." extends="ApiError">
...
<cfset setApiErrorType("OperatorError")>
