...
---> 
<cfcomponent displaname="alertserviceget" extends="utils">

<cfproperty name="selector" required="no" type="AlertSelector" hint="This field is required and should not be null." seq="1">
