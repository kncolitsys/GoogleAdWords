...
---> 
<cfcomponent displaname="DoubleComparisonOperation" hint="Object representing double comparison operations. This is usually used within a particular com.google.ads.api.services.targetingideas.search.SearchParameter to specify the valid values requested for the specific com.google.ads.api.services.targetingideas.attributes.Attribute." extends="utils">

<cfproperty name="minimum" required="no" type="double" hint="The minimum value of elements returned by this operation (inclusive)." seq="1">
<cfproperty name="maximum" required="no" type="double" hint="The maximum value of elements returned by this operation (inclusive)." seq="2">
