...
---> 
<cfcomponent displaname="WebpageDescriptorAttribute" hint="Attribute type that contains a WebpageDescriptor value." extends="Attribute">

<cfproperty name="value" required="no" type="WebpageDescriptor" hint="WebpageDescriptor value contained by this Attribute. This field is required and should not be null." seq="2">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setAttributeType("WebpageDescriptorAttribute")>
