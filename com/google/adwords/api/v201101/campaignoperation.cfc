...
---> 
<cfcomponent displaname="CampaignOperation" hint="An operation on an AdWords campaign. Note: The REMOVE operator is not supported. To remove a a campaign, set its status to DELETED." extends="Operation">
