...
---> 
<cfcomponent displaname="Budget" hint="Data representing the budget for a campaign." extends="utils">

<cfproperty name="period" required="no" type="string" hint="Period over which to spend the budget. MONTHLY is not available to most users. This field can be selected using the value 'Period'. This field is required and should not be null when it is contained within Operators : ADD." seq="1">
<cfproperty name="amount" required="no" type="Money" hint="Amount of budget. This field can be selected using the value 'Amount'.This field can be filtered on. This field must be greater than or equal to 1. This field is required and should not be null when it is contained within Operators : ADD." seq="2">
