...
<cfproperty name="name" required="no" type="string" hint="The name of this field. This field can be selected using the value 'TemplateElementFieldName'. This field is required and should not be null." seq="1">
<cfproperty name="type" required="no" type="string" hint="The type of this field. This field can be selected using the value 'TemplateElementFieldType'. This field is required and should not be null." seq="2">
<cfproperty name="fieldText" required="no" type="string" hint="Text value for text field types. Null if not text field. The field is a text field if type is ADDRESS, ENUM, TEXT, URL, or VISIBLE_URL. This field can be selected using the value 'TemplateElementFieldText'." seq="3">
