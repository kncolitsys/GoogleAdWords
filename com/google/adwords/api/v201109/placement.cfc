...
<cfproperty name="url" required="no" type="string" hint="Url of the placement. For example, 'http://www.domain.com'. This field can be selected using the value 'PlacementUrl'.This field can be filtered on. This field is required and should not be null when it is contained within Operators : ADD." seq="4">
