...
---> 
<cfcomponent displaname="SizeLimitError" hint="Indicates that the number of entries in the request or response exceeds the system limit." extends="ApiError">
...
<cfset setApiErrorType("SizeLimitError")>
