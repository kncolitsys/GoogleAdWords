...
---> 
<cfcomponent displaname="AdGroupCriterionError" hint="Base error class for Ad Group Criterion Service." extends="ApiError">
...
<cfset setApiErrorType("AdGroupCriterionError")>
