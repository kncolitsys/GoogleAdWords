...
<cfproperty name="percentServed" required="no" type="double" hint="Percentage of time this ad gets shown This field can be selected using the value 'PercentServed'." seq="29">
