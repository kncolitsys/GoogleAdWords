...
---> 
<cfcomponent displaname="BooleanAttribute" hint="Attribute type that contains a boolean value." extends="Attribute">

<cfproperty name="value" required="no" type="boolean" hint="Boolean value contained by this Attribute. This field is required and should not be null." seq="2">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setAttributeType("BooleanAttribute")>
