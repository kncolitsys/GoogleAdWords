...
---> 
<cfcomponent displaname="CampaignTargetOperation" extends="Operation">

<cfproperty name="operand" required="no" type="TargetList" hint="This field is required and should not be null." seq="3">
