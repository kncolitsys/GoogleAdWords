...
<cfproperty name="userListId" required="no" type="long" hint="Id of this user list. This is a required field. This field can be selected using the value 'UserListId'.This field can be filtered on." seq="3">
<cfproperty name="userListName" required="no" type="string" hint="This field can be selected using the value 'UserListName'." seq="4">
<cfproperty name="userListMembershipStatus" required="no" type="string" hint="This field can be selected using the value 'UserListMembershipStatus'.This field can be filtered on." seq="5">
