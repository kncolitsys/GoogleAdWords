...
<cffunction name="mutate" access="public" returntype="CampaignAdExtensionReturnValue" hint="Applies the list of mutate operations. @param operations The operations to apply. The same CampaignAdExtension cannot be specified in more than one operation. @return The changed CampaignAdExtensions. The Operator SET is not supported." output="No">
...
<cffunction name="getServiceUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['serviceUrl']" default="https://adwords.google.com/api/adwords/cm/v201109/CampaignAdExtensionService">
...
<cffunction name="getSandboxUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['sandboxUrl']" default="https://adwords-sandbox.google.com/api/adwords/cm/v201109/CampaignAdExtensionService">
