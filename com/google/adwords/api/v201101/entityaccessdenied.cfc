...
---> 
<cfcomponent displaname="EntityAccessDenied" hint="Reports permission problems trying to access an entity." extends="ApiError">
...
<cfset setApiErrorType("EntityAccessDenied")>
