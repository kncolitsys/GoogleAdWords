...
---> 
<cfcomponent displaname="ReadOnlyError" hint="A list of all errors associated with the @ReadOnly constraint." extends="ApiError">
...
<cfset setApiErrorType("ReadOnlyError")>
