...
---> 
<cfcomponent displaname="OperationAccessDenied" hint="Unauthorized access errors as determined by the invoked service's access policy." extends="ApiError">
...
<cfset setApiErrorType("OperationAccessDenied")>
