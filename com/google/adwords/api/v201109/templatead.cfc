...
<cfproperty name="dimensions" required="no" type="Dimensions" hint="The dimensions for this ad." seq="11">
<cfproperty name="name" required="no" type="string" hint="Name of this ad. This field can be selected using the value 'TemplateAdName'. This field is required and should not be null." seq="12">
<cfproperty name="duration" required="no" type="int" hint="Duration of this ad (if it contains playable media). This field can be selected using the value 'TemplateAdDuration'. This field is read only and should not be set. If this field is sent to the API, it will be ignored." seq="13">
