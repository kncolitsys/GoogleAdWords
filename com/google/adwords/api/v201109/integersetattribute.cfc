...
---> 
<cfcomponent displaname="IntegerSetAttribute" hint="Attribute type that contains a Set of integer values." extends="Attribute">

<cfproperty name="value" required="no" type="int[]" hint="Set of integer values contained by this Attribute. This field is required and should not be null." seq="2">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setAttributeType("IntegerSetAttribute")>
