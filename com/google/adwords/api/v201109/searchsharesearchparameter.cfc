...
---> 
<cfcomponent displaname="SearchShareSearchParameter" hint="A SearchParameter that specifies the percentage of search share expected in results. Absence of a SearchShareSearchParameter in a com.google.ads.api.services.targetingideas.TargetingIdeaSelector is equivalent to having no constraint on search share specified. This search parameter has a direct relationship to SEARCH_SHARE. This element is supported by following IdeaTypes: KEYWORD. This element is supported by following RequestTypes: IDEAS, STATS." extends="SearchParameter">
...
<cfset setSearchParameterType("SearchShareSearchParameter")>
