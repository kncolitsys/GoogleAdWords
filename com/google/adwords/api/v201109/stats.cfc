...
---> 
<cfcomponent displaname="Stats" hint="Statistics about an ad or criterion within an ad group or campaign." extends="utils">

<cfproperty name="startDate" required="no" type="string" hint="Starting date (inclusive) of the statistics. Format is YYYYMMDD." seq="1">
<cfproperty name="endDate" required="no" type="string" hint="Ending date (inclusive) of the statistics. Format is YYYYMMDD." seq="2">
...
<cfproperty name="invalidClicks" required="no" type="long" hint="Invalid clicks. Note: This field is valid for campaigns only. This field can be selected using the value 'InvalidClicks'.This field can be filtered on." seq="21">
<cfproperty name="invalidClickRate" required="no" type="double" hint="Invalid click rate. Note: This field is valid for campaigns only. This field can be selected using the value 'InvalidClickRate'.This field can be filtered on." seq="22">
<cfproperty name="numCalls" required="no" type="long" hint="Number of calls. This field can be selected using the value 'NumCalls'.This field can be filtered on." seq="23">
<cfproperty name="numMissedCalls" required="no" type="long" hint="Number of missed calls. This field can be selected using the value 'NumMissedCalls'.This field can be filtered on." seq="24">
<cfproperty name="numReceivedCalls" required="no" type="long" hint="Number of received calls. This field can be selected using the value 'NumReceivedCalls'.This field can be filtered on." seq="25">
<cfproperty name="callDurationSecs" required="no" type="long" hint="Total call duration (in seconds) of all calls. This field can be selected using the value 'CallDurationSecs'.This field can be filtered on." seq="26">
<cfproperty name="avgCallDurationSecs" required="no" type="double" hint="Average call duration in seconds. This field can be selected using the value 'AvgCallDurationSecs'.This field can be filtered on." seq="27">
<cfproperty name="Stats_Type" required="no" type="string" xmlattribute="xsi:type" xmlnamespace="xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns='https://adwords.google.com/api/adwords/cm/v201109'" hint="Indicates that this instance is a subtype of Stats. Although this field is returned in the response, it is ignored on input and cannot be selected. Specify xsi:type instead." seq="28">
...
<cffunction name="getNumCalls" access="public" returntype="any" output="No">
	
	<cfparam name="variables['instance']['numCalls']" default="">
	<cfreturn variables["instance"]["numCalls"]>
	
</cffunction>

<cffunction name="setNumCalls" access="public" returntype="void" output="No">
<cfargument name="numCalls" required="Yes" type="any">
	
	<cfset variables["instance"]["numCalls"]=arguments["numCalls"]>
		
</cffunction>

<cffunction name="getNumMissedCalls" access="public" returntype="any" output="No">
	
	<cfparam name="variables['instance']['numMissedCalls']" default="">
	<cfreturn variables["instance"]["numMissedCalls"]>
	
</cffunction>

<cffunction name="setNumMissedCalls" access="public" returntype="void" output="No">
<cfargument name="numMissedCalls" required="Yes" type="any">
	
	<cfset variables["instance"]["numMissedCalls"]=arguments["numMissedCalls"]>
		
</cffunction>

<cffunction name="getNumReceivedCalls" access="public" returntype="any" output="No">
	
	<cfparam name="variables['instance']['numReceivedCalls']" default="">
	<cfreturn variables["instance"]["numReceivedCalls"]>
	
</cffunction>

<cffunction name="setNumReceivedCalls" access="public" returntype="void" output="No">
<cfargument name="numReceivedCalls" required="Yes" type="any">
	
	<cfset variables["instance"]["numReceivedCalls"]=arguments["numReceivedCalls"]>
		
</cffunction>

<cffunction name="getCallDurationSecs" access="public" returntype="any" output="No">
	
	<cfparam name="variables['instance']['callDurationSecs']" default="">
	<cfreturn variables["instance"]["callDurationSecs"]>
	
</cffunction>

<cffunction name="setCallDurationSecs" access="public" returntype="void" output="No">
<cfargument name="callDurationSecs" required="Yes" type="any">
	
	<cfset variables["instance"]["callDurationSecs"]=arguments["callDurationSecs"]>
		
</cffunction>

<cffunction name="getAvgCallDurationSecs" access="public" returntype="any" output="No">
	
	<cfparam name="variables['instance']['avgCallDurationSecs']" default="">
	<cfreturn variables["instance"]["avgCallDurationSecs"]>
	
</cffunction>

<cffunction name="setAvgCallDurationSecs" access="public" returntype="void" output="No">
<cfargument name="avgCallDurationSecs" required="Yes" type="any">
	
	<cfset variables["instance"]["avgCallDurationSecs"]=arguments["avgCallDurationSecs"]>
