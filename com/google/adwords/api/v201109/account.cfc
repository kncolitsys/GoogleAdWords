...
<cfproperty name="currencyCode" required="no" type="string" hint="The currency in which this account operates. We support a subset of the currency codes derived from the ISO 4217 standard. See Currency Codes for the currently supported currencies. This field can only be set during creation of the account. This field is required and should not be null when it is contained within Operators : ADD. The length of this string should be between 3 and 3, inclusive." seq="5">
