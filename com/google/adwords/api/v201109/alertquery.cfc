...
<cfproperty name="triggerTime" required="no" type="string" hint="If TriggerTimeSpec CUSTOM_TIME is specified, only alerts generated after this time will be returned. String Format: yyyymmdd hhmmss zzz (e.g. 20100609 150223 UTC)." seq="6">
<cfproperty name="clientCustomerIds" required="no" type="long[]" hint="If ClientSpec ID_LIST is specified, only alerts for the client accounts specified here will be returned. This field must contain distinct elements." seq="7">
