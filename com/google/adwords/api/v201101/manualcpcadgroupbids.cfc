...
<cfproperty name="siteMaxCpc" required="no" type="Bid" hint="Max CPC bid for site targeting. This field can be selected using the value 'SiteMaxCpc'.This field can be filtered on." seq="4">
