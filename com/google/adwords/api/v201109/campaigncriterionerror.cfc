...
---> 
<cfcomponent displaname="CampaignCriterionError" hint="Base error class for Campaign Criterion Service." extends="ApiError">
...
<cfset setApiErrorType("CampaignCriterionError")>
