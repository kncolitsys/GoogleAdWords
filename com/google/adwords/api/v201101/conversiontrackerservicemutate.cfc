...
---> 
<cfcomponent displaname="conversiontrackerservicemutate" extends="utils">

<cfproperty name="operations" required="no" type="ConversionTrackerOperation[]" hint="This field must not contain null elements. Elements in this field must have distinct IDs for following Operators : SET, REMOVE. This field must contain at least one element. This field is required and should not be null. The following Operators are supported: ADD, SET." seq="1">
