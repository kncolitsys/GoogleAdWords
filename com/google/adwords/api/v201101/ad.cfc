...
---> 
<cfcomponent displaname="Ad" hint="The base class of all ad types. To update basic ad fields (such as status), you can construct an Ad object (instead of the ad's concrete type) with the appropriate fields set." extends="utils">

<cfproperty name="id" required="no" type="long" hint="ID of this ad. This field can be selected using the value 'Id'.This field can be filtered on. This field is read only and should not be set for following Operators : ADD. If this field is sent to the API, it will be ignored." seq="1">
...
<cfproperty name="Ad_Type" required="no" type="string" xmlattribute="xsi:type" xmlnamespace="xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns='https://adwords.google.com/api/adwords/cm/v201101'" hint="This field indicates the subtype of Ad of this instance. It is ignored on input, and instead xsi:type should be specified." seq="7">
