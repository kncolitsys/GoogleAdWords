...
---> 
<cfcomponent displaname="geolocationserviceget" extends="utils">

<cfproperty name="selector" required="no" type="GeoLocationSelector" hint="This field is required and should not be null." seq="1">
