...
<cfproperty name="status" required="no" type="string" hint="Status of this job. This field is read only and should not be set. If this field is sent to the API, it will be ignored." seq="9">
<cfproperty name="history" required="no" type="BulkMutateJobEvent[]" hint="History of status changes of this job. This field is read only and should not be set. If this field is sent to the API, it will be ignored." seq="10">
<cfproperty name="result" required="no" type="BulkMutateResult" hint="The selected result part of this job. This field is read only and should not be set. If this field is sent to the API, it will be ignored." seq="11">
<cfproperty name="numRequestParts" required="no" type="int" hint="Total number of request parts (maximum of 100) in this job." seq="12">
<cfproperty name="numRequestPartsReceived" required="no" type="int" hint="Number of request parts currently received via ADD and SET operations. This job will begin processing when numRequestPartsReceived equals numRequestParts. This field is read only and should not be set. If this field is sent to the API, it will be ignored." seq="13">
