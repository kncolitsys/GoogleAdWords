...
---> 
<cfcomponent displaname="StatsQueryError" hint="Represents possible error codes when querying for stats." extends="ApiError">
...
<cfset setApiErrorType("StatsQueryError")>
