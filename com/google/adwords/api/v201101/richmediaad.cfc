...
<cfproperty name="name" required="no" type="string" hint="Name of the rich media ad. This field can be selected using the value 'Name'. This field is required and should not be null." seq="8">
<cfproperty name="dimensions" required="no" type="Dimensions" hint="Dimensions (height and width) of the ad. It's required for standard third party ads. This field can be selected using the value 'Dimensions'." seq="9">
<cfproperty name="snippet" required="no" type="string" hint="Snippet for this ad. It's required for standard third party ads. This field can be selected using the value 'Snippet'." seq="10">
<cfproperty name="impressionBeaconUrl" required="no" type="string" hint="Impression beacon URL for the ad. This field can be selected using the value 'ImpressionBeaconUrl'." seq="11">
<cfproperty name="certifiedVendorFormatId" required="no" type="long" hint="Certified VendorFormat Id. This field can be selected using the value 'CertifiedVendorFormatId'. This field is required and should not be null." seq="12">
