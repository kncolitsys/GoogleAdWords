...
---> 
<cfcomponent displaname="AdGroupAdPage" hint="Represents a page of AdGroupAds resulting from the query done by AdGroupAdService." extends="Page">

<cfproperty name="entries" required="no" type="AdGroupAd[]" hint="The result entries in this page." seq="3">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setPageType("AdGroupAdPage")>
