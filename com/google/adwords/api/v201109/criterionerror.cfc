...
---> 
<cfcomponent displaname="CriterionError" hint="Error class used for reporting criteria related errors." extends="ApiError">
...
<cfset setApiErrorType("CriterionError")>
