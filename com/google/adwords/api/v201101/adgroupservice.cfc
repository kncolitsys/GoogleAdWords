...
<cffunction name="mutate" access="public" returntype="AdGroupReturnValue" hint="Mutates (add, remove and set) ad groups as specified by the operations. Note: to REMOVE use SET and mark status to DELETE. @param operations list of unique operations. The same ad group cannot be specified in more than one operation. @return the updated adgroups." output="No">
...
<cffunction name="getServiceUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['serviceUrl']" default="https://adwords.google.com/api/adwords/cm/v201101/AdGroupService">
...
<cffunction name="getSandboxUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['sandboxUrl']" default="https://adwords-sandbox.google.com/api/adwords/cm/v201101/AdGroupService">
