...
---> 
<cfcomponent displaname="ConversionOptimizer" hint="Conversion optimizer bidding strategy. For more information, visit the Conversion Optimizer site." extends="BiddingStrategy">
