...
---> 
<cfcomponent displaname="CampaignTargetReturnValue" hint="A container for return values from the mutate()." extends="ListReturnValue">

<cfproperty name="value" required="no" type="TargetList[]" hint="The list of TargetLists belonging to the current page." seq="2">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setListReturnValueType("CampaignTargetReturnValue")>
