...
<cfproperty name="bidSource" required="no" type="string" hint="The level (ad group or criterion) at which this bid was set. This field can be selected using the value 'CpmBidSource'.This field can be filtered on. This field is read only and should not be set. If this field is sent to the API, it will be ignored." seq="3">
