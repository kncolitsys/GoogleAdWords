...
<cfproperty name="text" required="no" type="string" hint="Text of this keyword (at most 80 characters and ten words). This field can be selected using the value 'KeywordText'.This field can be filtered on. This string must match the regular expression '[^\x00]*' This field is required and should not be null when it is contained within Operators : ADD." seq="4">
<cfproperty name="matchType" required="no" type="string" hint="Match type of this keyword. This field can be selected using the value 'KeywordMatchType'.This field can be filtered on. This field is required and should not be null when it is contained within Operators : ADD." seq="5">
