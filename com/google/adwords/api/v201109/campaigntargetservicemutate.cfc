...
---> 
<cfcomponent displaname="campaigntargetservicemutate" extends="utils">

<cfproperty name="operations" required="no" type="CampaignTargetOperation[]" hint="This field must not contain null elements. This field must contain at least one element. This field is required and should not be null. The following Operators are supported: SET." seq="1">
