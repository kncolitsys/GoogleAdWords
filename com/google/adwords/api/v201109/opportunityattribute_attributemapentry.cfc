...
---> 
<cfcomponent displaname="OpportunityAttribute_AttributeMapEntry" hint="This represents an entry in a map with a key of type OpportunityAttribute and value of type Attribute." extends="utils">
