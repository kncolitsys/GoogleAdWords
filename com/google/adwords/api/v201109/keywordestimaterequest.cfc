...
<cfproperty name="isNegative" required="no" type="boolean" hint="Whether the keyword is negative or not. The default value is false. If negative, no current ad group ads will appear for searches containing this keyword. The estimate for negative keywords should reflect no traffic and zero CPC, but including a negative keyword will affect the other estimates in the request." seq="4">
...
<cffunction name="getIsNegative" access="public" returntype="any" output="No">
	
	<cfparam name="variables['instance']['isNegative']" default="">
	<cfreturn variables["instance"]["isNegative"]>
	
</cffunction>

<cffunction name="setIsNegative" access="public" returntype="void" output="No">
<cfargument name="isNegative" required="Yes" type="any">
	
	<cfset variables["instance"]["isNegative"]=arguments["isNegative"]>
