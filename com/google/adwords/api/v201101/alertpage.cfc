...
---> 
<cfcomponent displaname="AlertPage" hint="Contains a subset of Alerts resulting from the filtering and paging, returned by get(AlertSelector)." extends="NoStatsPage">

<cfproperty name="entries" required="no" type="Alert[]" seq="1">
