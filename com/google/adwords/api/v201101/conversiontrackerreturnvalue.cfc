...
---> 
<cfcomponent displaname="ConversionTrackerReturnValue" hint="A container for return values from the ConversionTrackerService." extends="ListReturnValue">

<cfproperty name="value" required="no" type="ConversionTracker[]" seq="2">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setListReturnValueType("ConversionTrackerReturnValue")>
