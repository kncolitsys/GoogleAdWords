...
---> 
<cfcomponent displaname="servicedaccountserviceget" extends="utils">

<cfproperty name="selector" required="no" type="ServicedAccountSelector" hint="This field is required and should not be null." seq="1">
