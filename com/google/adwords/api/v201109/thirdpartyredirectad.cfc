...
<cfproperty name="videoTypes" required="no" type="string[]" hint="Video Types of the ad. (RealMedia, Quick Time etc.) This field can be selected using the value 'VideoTypes'." seq="4">
