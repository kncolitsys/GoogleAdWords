...
<cfproperty name="conditions" required="no" type="ProductCondition[]" hint="Product filter conditions. The condition in the product criteria is defined as {operand1=argument1,operand2=argument2. The product conditions are anded to evaluate the targeting parameter. null conditions means that all products are targeted." seq="3">
<cfproperty name="text" required="no" type="string" hint="Product criteria parameter This field can be selected using the value 'Text'. This field is read only and should not be set. If this field is sent to the API, it will be ignored." seq="4">
