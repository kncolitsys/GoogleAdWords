...
<cfproperty name="numberResults" required="no" type="int" hint="Maximum number of results to return in this page. Set this to a reasonable value to limit the number of results returned per page. This field must be greater than or equal to 0." seq="2">
