...
---> 
<cfcomponent displaname="CampaignCriterionService" hint="Use this service to manage campaign-level criteria. A campaign-level negative criterion prevents the campaign's ads from showing on specific placements, specific keywords, demographics, and so on. Additionally, the service can be used to target criteria such as location, language, carrier, platform, and so on. The targeting criteria can be added using the Criterion Id listed in the appendix, e.g. http://code.google.com/apis/adwords/docs/appendix/platforms.html" extends="utils">
...
<cffunction name="getServiceUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['serviceUrl']" default="https://adwords.google.com/api/adwords/cm/v201109/CampaignCriterionService">
...
<cffunction name="getSandboxUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['sandboxUrl']" default="https://adwords-sandbox.google.com/api/adwords/cm/v201109/CampaignCriterionService">
