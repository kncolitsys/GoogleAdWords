...
---> 
<cfcomponent displaname="TargetError" hint="A list of all the error codes being used by the common targeting package." extends="ApiError">
...
<cfset setApiErrorType("TargetError")>
