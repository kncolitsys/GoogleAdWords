...
---> 
<cfcomponent displaname="CollectionSizeError" hint="A list of all errors associated with the @ContentsSize constraint." extends="ApiError">
...
<cfset setApiErrorType("CollectionSizeError")>
