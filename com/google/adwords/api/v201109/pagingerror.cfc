...
---> 
<cfcomponent displaname="PagingError" hint="Error codes for pagination. See com.google.ads.api.services.common.pagination.Paging." extends="ApiError">
...
<cfset setApiErrorType("PagingError")>
