...
<cfproperty name="isEnumType" required="no" type="boolean" hint="Indicates that the field is an enum type. This field is read only and should not be set. If this field is sent to the API, it will be ignored." seq="8">
<cfproperty name="enumValuePairs" required="no" type="EnumValuePair[]" hint="List of enum values in api to their corresponding display values in the downloaded reports. This field is read only and should not be set. If this field is sent to the API, it will be ignored." seq="9">
...
<cffunction name="getIsEnumType" access="public" returntype="any" output="No">
	
	<cfparam name="variables['instance']['isEnumType']" default="">
	<cfreturn variables["instance"]["isEnumType"]>
	
</cffunction>

<cffunction name="setIsEnumType" access="public" returntype="void" output="No">
<cfargument name="isEnumType" required="Yes" type="any">
	
	<cfset variables["instance"]["isEnumType"]=arguments["isEnumType"]>
