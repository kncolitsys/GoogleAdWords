...
---> 
<cfcomponent displaname="ExperimentServiceError" hint="Base error class for Experiment Service." extends="ApiError">
...
<cfset setApiErrorType("ExperimentServiceError")>
