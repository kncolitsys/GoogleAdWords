...
---> 
<cfcomponent displaname="SelectorError" hint="Represents possible error codes for Selector." extends="ApiError">

<cfproperty name="reason" required="no" type="string" hint="The error reason represented by enum." seq="5">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setApiErrorType("SelectorError")>
