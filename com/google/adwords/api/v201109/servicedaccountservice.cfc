...
---> 
<cfcomponent displaname="ServicedAccountService" hint="Use this service to retrieve accounts managed (directly or indirectly) by your MCC account. The returned graph contains a list of all managed accounts and a list of links, where each link describes the relationship between two accounts." extends="utils">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>


<cffunction name="get" access="public" returntype="ServicedAccountGraph" hint="Returns a representation of the managed-account relationships related to this account. @param selector determines which accounts and links to retrieve @return the selected list of accounts and serviced account links between them @throws ApiException if an error occurs" output="No">
<cfargument name="selector" required="no" type="ServicedAccountSelector" hint="This field is required and should not be null."> 
...
<cfset var stTemp="">
<cfset var oServicedAccountServiceGet="">

	<!--- use errorhandling --->
	<cftry>

		<cfset oServicedAccountServiceGet=createObject("component","servicedaccountserviceget")>
		<cfset oServicedAccountServiceGet.setSelector(selector)>
		
		<cfset variables["instance"]["get"]=oServicedAccountServiceGet>
		...
		<cfset stResponse=getService().callWebService("ServicedAccountService",this)>
		...
		<cfif ArrayLen(aResponse) gt 0>
			...
			<cfif isArray(aResponse)>
				...
				<cfloop from="1" to="#arrayLen(aResponse)#" index="j">
					<cfset oTemp=createObject("component","ServicedAccountGraph")>
			...
			<cfelseif isStruct(aResponse) and not structIsEmpty(aResponse)>
				<!--- create empty instance of an ServicedAccountGraph object and set data inside returning object --->
				<cfset oTemp=createObject("component","ServicedAccountGraph")>
				<cfset oTemp.setObjectData(aResponse)>
				<cfset oReturnValue=oTemp>
			<cfelse>
				<cfthrow message="The api returned an empty result." detail="You can check the SOAPRequest and SOAPResponse data through the variables SOAPRequest and SOAPResponse. e.g. oServicedAccountService.getService().SOAPRequest">
			</cfif>
...
<cffunction name="getServiceUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['serviceUrl']" default="https://adwords.google.com/api/adwords/mcm/v201109/ServicedAccountService">
...
<cffunction name="getSandboxUrl" access="public" returntype="any" output="No">
	...
	<cfparam name="variables['instance']['sandboxUrl']" default="https://adwords-sandbox.google.com/api/adwords/mcm/v201109/ServicedAccountService">
