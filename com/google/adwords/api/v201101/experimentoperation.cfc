...
---> 
<cfcomponent displaname="ExperimentOperation" hint="Operation for adding, updating or removing operations. For removing, use SET and mark status as DELETED." extends="Operation">

<cfproperty name="operand" required="no" type="Experiment" seq="3">

<!--- create empty structure instance to store property data ---> 
<cfset variables["instance"]=StructNew()>
<!--- set the type of the extending cfc  --->
<cfset setOperationType("ExperimentOperation")>
