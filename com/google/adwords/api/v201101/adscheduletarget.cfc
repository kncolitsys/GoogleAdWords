...
<cfproperty name="startHour" required="no" type="int" hint="Starting hour in 24 hour time (0..23). This field must be between 0.0 and 23.0, inclusive." seq="3">
...
<cfproperty name="endHour" required="no" type="int" hint="Ending hour in 24 hour time (0..24); 24 signifies end of the day. This field must be between 0.0 and 24.0, inclusive." seq="5">
