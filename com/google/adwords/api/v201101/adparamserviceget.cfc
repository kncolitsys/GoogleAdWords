...
---> 
<cfcomponent displaname="adparamserviceget" extends="utils">

<cfproperty name="selector" required="no" type="AdParamSelector" hint="This field is required and should not be null." seq="1">
