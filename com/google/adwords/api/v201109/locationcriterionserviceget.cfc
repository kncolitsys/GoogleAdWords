...
---> 
<cfcomponent displaname="locationcriterionserviceget" extends="utils">

<cfproperty name="selector" required="no" type="Selector" hint="This field is required and should not be null." seq="1">
