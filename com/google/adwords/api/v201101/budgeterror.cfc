...
---> 
<cfcomponent displaname="BudgetError" hint="A list of all the error codes being used by the common budget domain package." extends="ApiError">
...
<cfset setApiErrorType("BudgetError")>
