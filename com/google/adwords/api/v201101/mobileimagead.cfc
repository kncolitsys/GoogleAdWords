...
<cfproperty name="markupLanguages" required="no" type="string[]" hint="The list of markup languages to use for the mobile ad. This field can be selected using the value 'MarkupLanguages'." seq="8">
<cfproperty name="mobileCarriers" required="no" type="string[]" hint="The list of mobile carriers to use for the mobile ad. Each string must be of the form 'CarrierName@CountryCode'. To specify that all available carriers are to be used, use the reserved keyword 'ALLCARRIERS'. See available mobile carriers. This field can be selected using the value 'MobileCarriers'. This field is required and should not be null." seq="9">
<cfproperty name="image" required="no" type="Image" hint="Image to be used in the mobile image ad. This field can be selected using the value 'Image'." seq="10">
